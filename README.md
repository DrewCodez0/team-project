...
The API generates random words with customizable parameters such as length and language. 
- Free Dictionary API (https://dictionaryapi.dev/)
The API returns the definitions of the selected word. It could be used to check if a word is in a dictionary. 
- Random Word API 2 (https://random-word-api.vercel.app)
Serves a similar purpose as Random Word API and is used when the first API is down or unavailable.
- Free Dictionary API 2 (https://freedictionaryapi.com/ )
